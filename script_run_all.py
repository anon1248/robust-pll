...
ALGOS: Dict[str, Tuple[int, Type[PllBaseClassifier]]] = {
    ...
    "cavl-2021": (8, Cavl),
    "pop-2023": (9, Pop),
    "dst-pll-2024": (10, DstPll),
    # Proden variations
    "proden-l2": (11, ProdenL2),
    "proden-dropout": (12, ProdenDropout),
    "proden-ens": (13, ProdenEnsemble),
    "proden-adv-ens": (14, ProdenAdvEns),
    "proden-edl": (15, ProdenEdl),
    # Our methods
    "robust-pll": (16, RobustPll),
    "robust-pll-ens": (17, RobustPllEnsemble),
}
